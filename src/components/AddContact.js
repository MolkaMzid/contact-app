...
class AddContact extends Component {
    ...
    AddContact=()=>{
        Axios.post("http://localhost:4000/add_contact",{name:this.state.name,email:this.state.email,phone:this.state.phone}).then(res=>this.setState({add_elem:[...this.state.add_elem,res.data]})).catch(er=>alert(er))
